...
def translation_dictionary() -> Dict[Tuple[str, str], str]:
    ...
    return {
        ...
        ("Operator", "从提取路径导入模型"): "Import Models from Extraction Path",
        ...
        ("*", "3Dmigoto 帧提取文件路径"): "3Dmigoto Frame Dump Path",
